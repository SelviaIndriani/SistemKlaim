...
<div class="card">
  <div class="card-body">
    ...
    <!-- Button Create -->
    <button type="button" class="btn btn-primary mb-2" id="tambah_data" name="tambah_data" data-bs-toggle="modal" data-bs-target="#produkModal">
    ...
    <div class="table-responsive-xxl">
      <table class="table table-bordless w-100 table-striped my-datatable-produk" id="produkTable">
    ...
    <div class="modal fade" id="produkModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="produkModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <form action="{{ route('produk.tambah') }}" id="produkForm" class="row g-3" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body mx-3" >
              ...
              <div class="row mb-3">
                <div class="col-md-12">
                  ...
                  <input type="number" class="form-control" id="mm_awal" name="mm_awal" step="0.01" required>
                </div>
              </div>
        ...
        url : '/produk/hapus/'+prd_id,
            success:function(data)
            {
              $('#alert-success').remove();
                ...
                var html = '<div class="alert alert-success alert-dismissible fade show" role="alert">Produk berhasil dihapus.' ;
