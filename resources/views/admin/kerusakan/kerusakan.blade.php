    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive-sm">
                <table class="table table-bordless w-100 table-striped " id="my-datatable-kerusakan">
            ...
            <div class="modal fade" id="dmgModal" data-bs-backdrop="static" tabindex="-1"
                aria-labelledby="kerusakanModalLabel" aria-hidden="true">
