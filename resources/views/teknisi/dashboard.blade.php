                ...
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        <ul class="nav nav-tabs nav-fill mb-3" id="tab1" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active fw-bold" data-bs-toggle="tab" href="#pending" role="tab"
                                    aria-controls="pending" aria-current="page">Data Klaim Pending</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fw-bold" data-bs-toggle="tab" href="#approved" role="tab"
                                    aria-controls="approved" aria-current="page">Data Klaim Approved</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="pending">
                            ...
                            <div class="table-responsive-xxl">
                                <table class="table table-bordless w-100 table-striped" id="my-datatable-klaim-pending">
                        ...
                        <div role="tabpanel" class="tab-pane" id="approved">
                            <!-- DataTable -->
                            <div class="table-responsive-xxl">
                                <table class="table table-bordless w-100 table-striped" id="my-datatable-klaim-approved">
                                    <thead class="table-success w-100">
                                        <tr>
                                            <th></th>
                                            <th class="text-center">ID Klaim</th>
